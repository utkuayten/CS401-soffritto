...
if __name__ == "__main__":
    ...
    # Our model outputs
    pred_path = str(PROJECT_ROOT / "transoffritto/GenomicBert/results/H1_val6_test9/pred.npy")
    true_path = str(PROJECT_ROOT / "transoffritto/GenomicBert/results/H1_val6_test9/true.npy")

    # Other model predictions (your attached file is a .npy)
    other_pred_path = str(PROJECT_ROOT / "transoffritto/GenomicBert/results/H1_val6_test9/H1_chr9_pred_intra_cell_line.npy")
